...
class AuthViewModel @Inject constructor(
    ...
    private val signInResponseMutable = MutableLiveData<Response<Boolean>>()
    val signInResponse: LiveData<Response<Boolean>> get() = signInResponseMutable
    private val signOutResponseMutable = MutableLiveData<Response<Boolean>>()
    val signOutResponse: LiveData<Response<Boolean>> get() = signOutResponseMutable
